 ...
 *
 *
 * @param {('721'|'1155'|'gift'|'dpCreations')}   contractType   Type of contract.
...
const getSignedVoucher = async (contract, contractType, values, cAdr, vAdr) => {
  ...
  switch (contractType) {
    case "721":
      contractConst = constants.contracts.mint721;
      types = constants.types.ERC721;
      price = values.value;
      tokenId = values.tokenId;
      start = values.start;
      end = values.end;
      royalty = values.royalty * royaltyMultiplier;
      isStealth = values.stealth;
      isSbt = values.sbt;
      voucher = { tokenId, price, start, end, royalty, isStealth, isSbt };
      break;
    case "1155":
      contractConst = constants.contracts.mint1155;
      types = constants.types.ERC1155;
      price = values.value;
      ...
      // console.log("voucher to sign: ", voucher);
      break;
    case "gift":
      contractConst = constants.contracts.gift;
      types = constants.types.Gift;
      tokenId = values.tokenId;
      price = values.price;
      giftType = values.giftType;
      giftVariant = values.giftVariant;
      feesCovered = values.feesCovered;
      ...
      break;
    case "dpCreations":
      contractConst = constants.contracts.dappunkCreations;
      types = constants.types.ERC1155;
      price = values.price;
      quantity = values.quantity;
      buyerQty = values.buyerQty;
  ...
  const domain = {
    name: contractConst.domain.domain,
